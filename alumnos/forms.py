...
class DocumentosAlumnoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "acta_nacimiento": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "curp": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "certificado_estudios": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "titulo_grado": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "solicitud_registro": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "validacion_autenticidad": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "carta_compromiso": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "carta_interes": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "identificacion_oficial": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
            "otro_documento": ClearableFileInputAccept(attrs={"class":"form-control-file"}),
        }